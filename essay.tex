...
el teclado y otro para la salida del módem, en sus propias palabras esto era:
\begin{quote}
 \textbf{\textit{“un juego de prueba para entender cómo interactuar con el hardware”}\cite{torvalds_just_2002} }   
\end{quote}
El siguiente desafío surgió cuando intentó descargar archivos de la universidad, necesitaba
...
\begin{quote}
    ...
    adoptado. Sin contribuciones externas, el proyecto habría muerto en meses”}\cite{torvalds_just_2002}} 
\end{quote}
...
Sin embargo, la relación entre la comunidad del software libre y BitMover
(empresa dueña de BitKeeper) era tensa desde el inicio, por la misma naturaleza
cerrada de BitKeeper. Aunque ofrecía licencias gratuitas para uso no comercial
en proyectos de código abierto, esta concesión era frágil. En 2005, tras una
serie de desacuerdos, BitMover decidió retirar el acceso libre a BitKeeper para
los desarrolladores del kernel de Linux. Este evento dejó a la comunidad sin una
herramienta viable para gestionar el desarrollo del proyecto.
...
\end{quote}
\begin{quote}
\textbf{(“the stupid content tracker”)\cite{torvalds_just_2002} }
\end{quote}
...
\bibliography{bibliography}    % nombre de tu .bib (sin extensión)
