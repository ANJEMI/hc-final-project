...
máquinas de 8 bits, \hyperlink{cpm}{CP/M} se instaló en millones de dispositivos,
...
algunas de ellas son: Intel, Google, \hyperlink{ibm}{IBM}, AMD, Valve, Dell, Lenovo, Asus,
...
sistemas comerciales como UNIX ni de desarrollar algo tan ambicioso como \hyperlink{gnu}{GNU}. Su
...
Otro elemento clave fue la decisión de licenciar Linux bajo la \hyperlink{gnu}{GNU} General
Public License (\hyperlink{gpl}{GPL}), ya que esta, permitía a cualquier persona usar, modificar
...
\begin{itemize}
    \item \textbf{Desarrollo centralizado vs. desarrollo distribuido:} 
        Los modelos tradicionales, como los utilizados por \hyperlink{microsoft}{Microsoft} en el
...
de licenciar Linux bajo la \hyperlink{gnu}{GNU} \hyperlink{gpl}{GPL} fue crucial, ya que permitió el acceso,
...
sistemas y luego desarrolló macOS, basado en BSD.
...
estadounidense, pionera en computación y redes. Desarrolló UNIX en Bell Labs y
fue clave en la creación de estándares tecnológicos.

\item \hypertarget{basic}{\textbf{BASIC:}} Lenguaje de programación sencillo,
popular en microcomputadoras. Usado en entornos educativos.
...
versiones propietaria usada temporalmente para Linux, cuyo conflicto de licencia
llevó a la creación de Git.
...
de UNIX desarrollada en UC Berkeley. Base para sistemas como macOS y proyectos
libres.

\item \hypertarget{cobolfortran}{\textbf{COBOL/FORTRAN:}} Lenguajes de
programación para negocios (COBOL) y ciencia (FORTRAN). Dominaron en mainframes.

\item \hypertarget{copyleft}{\textbf{Copyleft:}} Filosofía que usa derechos de
autor para asegurar que las obras derivadas mantengan libertades, contraria al
copyright restrictivo.

\item \hypertarget{cpm}{\textbf{CP/M (Control Program for Microcomputers):}}
Sistema operativo de 8 bits de Digital Research, precursor de MS-DOS. Popular en
los 70, pero eclipsado por la llegada de IBM PC con MS-DOS.

\item \hypertarget{debian}{\textbf{Debian:}} Distribución de Linux creada en
1993 por Ian Murdock. Conocida por su enfoque comunitario y su sistema de
gestión de paquetes APT (Advanced Package Tool).

\item \hypertarget{digitalresearch}{\textbf{Digital Research:}} Empresa fundada
por Gary Kildall, creadora de CP/M. Competidora temprana de Microsoft en
sistemas para microcomputadoras.

\item \hypertarget{dmca}{\textbf{DMCA (Digital Millennium Copyright Act):}} Ley
estadounidense que regula derechos de autor, a veces limitando la distribución
de software libre.

\item \hypertarget{fosdem}{\textbf{FOSDEM (Free and Open Source Developers'
European Meeting):}} Conferencia anual para desarrolladores de software libre en
Europa.

\item \hypertarget{ftp}{\textbf{FTP (File Transfer Protocol):}} Protocolo de red
estándar para la transferencia de archivos entre un cliente y un servidor sobre
una red TCP/IP.

\item \hypertarget{gcc}{\textbf{GCC (GNU Compiler Collection):}} Conjunto de
compiladores libres para C, C++, Fortran y otros lenguajes.

\item \hypertarget{github}{\textbf{GitHub:}} Plataforma basada en Git para
alojar proyectos y facilitar colaboración. Centralizó el desarrollo de código
abierto en la década de 2010.

\item \hypertarget{gnu}{\textbf{GNU (GNU's Not UNIX):}} Proyecto para crear un
sistema operativo libre compatible con UNIX. Combinado con Linux, formó
GNU/Linux.

\item \hypertarget{gpl}{\textbf{GPL (Licencia Pública General):}} Licencia
copyleft que garantiza libertades de uso, modificación y distribución. Usada en
...
del MIT para mainframes, escrito en Assembler. Ejemplo temprano de software
colaborativo.

\item \hypertarget{kernel}{\textbf{Kernel (Núcleo):}} Parte central de un
sistema operativo que gestiona recursos del hardware. Linux es un kernel, no un
sistema operativo completo.

\item \hypertarget{licencias}{\textbf{Licencias MIT/Apache:}} Licencias
permisivas de código abierto, populares en GitHub. Permiten reutilización con
menos restricciones que la GPL.

\item \hypertarget{mainframe}{\textbf{Mainframe:}} Computadoras grandes y
potentes para procesamiento masivo de datos, usadas en entornos corporativos
(ej: OS/360 de IBM).

\item \hypertarget{meritocracia}{\textbf{Meritocracia Técnica:}} Modelo donde
las contribuciones se juzgan por su calidad técnica, no por jerarquías. Usado en
el desarrollo de Linux.

\item \hypertarget{minix}{\textbf{MINIX:}} Sistema operativo educativo de código
abierto creado por Andrew S. Tanenbaum. Usado por Linus Torvalds como
inspiración para Linux.

\item \hypertarget{microsoft}{\textbf{Microsoft:}} Gigante tecnológico creador
de MS-DOS y Windows. Representó el modelo de software propietario, en contraste
con el código abierto.

\item \hypertarget{mitapache}{\textbf{Licencias MIT/Apache:}} Licencias
permisivas de código abierto, populares en GitHub. Permiten reutilización con
menos restricciones que la GPL.

\item \hypertarget{msdos}{\textbf{MS-DOS (Microsoft Disk Operating System):}}
Sistema operativo de línea de comandos para PCs compatibles con IBM. Dominó el
mercado en los 80-90 y sentó las bases para Windows.

\item \hypertarget{openstreetmap}{\textbf{OpenStreetMap:}} Proyecto colaborativo
para crear mapas libres, usando infraestructura basada en Linux.

\item \hypertarget{os360}{\textbf{OS/360:}} Sistema operativo de IBM para
mainframes, destacado por su complejidad y papel en la "crisis del software" de
los 60.

\item \hypertarget{pascal}{\textbf{Pascal:}} Lenguaje estructurado usado en
enseñanza de programación. Influenció prácticas de desarrollo.

\item \hypertarget{raspberrypi}{\textbf{Raspberry Pi:}} Computadora de bajo
costo con Linux, usada en educación y proyectos de hardware.

\item \hypertarget{redhatcanonical}{\textbf{Red Hat/Canonical:}} Empresas que
comercializan soporte para distribuciones Linux (Red Hat Enterprise Linux,
Ubuntu).

\item \hypertarget{richardstallman}{\textbf{Richard Stallman:}} Programador y
activista del software libre, fundador del proyecto GNU y de la Free Software
Foundation.

\item \hypertarget{slackware}{\textbf{Slackware:}} Una de las distribuciones de
Linux más antiguas (creada en 1993 por Patrick Volkerding). Con énfasis en la
estabilidad y el diseño Unix “tradicional”.

\item \hypertarget{sun}{\textbf{Sun (Sun Microsystems):}} Empresa tecnológica
fundada en 1982, conocida por sus estaciones de trabajo y servidores basados en
UNIX. Desarrolló Solaris (un sistema operativo UNIX) y el lenguaje de
programación Java.

\item \hypertarget{suse}{\textbf{SUSE:}} Distribución de Linux fundada en
Alemania en 1992 (originalmente S.u.S.E.). Conocida por sus herramientas de
administración como YaST (Yet another Setup Tool).
