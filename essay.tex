...
el teclado y otro para la salida del módem, en sus propias palabras \cite{torvalds_just_2002} esto era:
\begin{quote}
 \textbf{\textit{“un juego de prueba para entender cómo interactuar con el hardware”}}   
\end{quote}
...
abierta Torlavds \cite{torvalds_just_2002} dijo:
...
que describió con humor \cite{torvalds_just_2002} como 
\begin{quote}
